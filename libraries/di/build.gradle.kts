...
kotlin {
    ...
    androidLibrary {
        namespace = "io.getsafenow.libraries.di"
        compileSdk = 36
        minSdk = 24
...
dependencies {
    ...
    add("kspIosX64", libs.kotlinInject.compiler)          // iOS simulator (Intel)
    add("kspIosSimulatorArm64", libs.kotlinInject.compiler) // iOS simulator (Apple Silicon)
