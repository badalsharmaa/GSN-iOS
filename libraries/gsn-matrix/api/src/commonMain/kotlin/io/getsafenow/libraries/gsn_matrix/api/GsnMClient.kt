...
import io.getsafenow.libraries.gsn_matrix.api.createroom.CreateRoomParameters
import io.getsafenow.libraries.gsn_matrix.api.encryption.EncryptionService
import io.getsafenow.libraries.gsn_matrix.api.media.MatrixMediaLoader
import io.getsafenow.libraries.gsn_matrix.api.media.MediaPreviewService
import io.getsafenow.libraries.gsn_matrix.api.notification.NotificationService
import io.getsafenow.libraries.gsn_matrix.api.notificationsettings.NotificationSettingsService
import io.getsafenow.libraries.gsn_matrix.api.oidc.AccountManagementAction
import io.getsafenow.libraries.gsn_matrix.api.pusher.PushersService
...
interface GsnMClient {
    val sessionId: SessionId
    val deviceId: DeviceId
    val userProfile: StateFlow<GsnMUser>
     ...
     */
    suspend fun getUserProfile(): Result<GsnMUser>
     ...
     */
    fun getRoomInfoFlow(roomId: RoomId): Flow<KmpOptional<RoomInfo>>
     ...
     *
     */
    suspend fun resolveRoomAlias(roomAlias: RoomAlias): Result<KmpOptional<ResolvedRoomAlias>>
 ...
 */
fun GsnMClient.roomAliasFromName(name: String): RoomAlias? {
