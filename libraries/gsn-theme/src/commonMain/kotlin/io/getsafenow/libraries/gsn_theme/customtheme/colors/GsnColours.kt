...
/**
 * Centralised Theme Colors class for GetSafeNow Android and iOS Both.
 * This class holds all the variables of the Gsn Custom theme Colours.
 * Note: Colours from here to use only for centralisation purpose in each app module.
 */
@Immutable
data class GsnColours(
